				...
				async.map(tableNames, (tableName, tableCallback) => {
					...
					.then(table => {
						...
						if (columns) {
                            ...
                            packageData.bucketInfo = {
                                replicationFactor: keyspaceMetaData.strategyOptions.replication_factor,
                                durableWrites: keyspaceMetaData.durableWrites,
                                strategy: keyspaceMetaData.strategy
                            };
            ...
            if (!tableNames.length) {
                ...
                async.map(tableNames, (tableName, tableCallback) => {
                    ...
                    packageData.bucketInfo = {
                        replicationFactor: keyspaceMetaData.strategyOptions.replication_factor,
                        durableWrites: keyspaceMetaData.durableWrites,
                        strategy: keyspaceMetaData.keyspaceMetaData
                    };
